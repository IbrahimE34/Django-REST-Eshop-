Eshop API — учебный проект интернет-магазина, разработанный с использованием Django REST Framework. Проект включает систему регистрации пользователей, JWT-аутентификацию, управление товарами, корзиной и заказами, а также реализует бизнес-логику обработки заказов с использованием транзакций.
